          ...
          {posts.map((posts, index) => (
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <h3 className="text-xl font-semibold text-uConnectDark-accent">{posts.name}</h3>
                <p className="text-uConnectLight-textSub dark:text-uConnectDark-textSub break-words ml-5 text-xs">{posts.time}</p>
                </div>
                <p className="text-uConnectLight-textMain dark:text-uConnectDark-textMaintext-uConnectLight-textSub dark:text-uConnectDark-textSub mb-2">{posts.majorAndYear}</p>
                <p className="text-uConnectLight-textMain dark:text-uConnectDark-textMain mb-4">{posts.description}</p>
                <img
                src={posts.postImage}
                alt={`${posts.name}`}
                className="-ms-16"
